  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.wrap}>
        ...
        <Text style={s.ver}>Escaneo rápido de pallets · v1.0</Text>
      </View>
    </SafeAreaView>
  );
}
...
const s = StyleSheet.create({
  ...
  logoRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 48, gap: 10 },
  logoBox: {
  ...
  sub: { color: C.textSec, fontSize: 14, textAlign: 'center', marginBottom: 32 },
  list: { gap: 10 },
  card: {
  ...
  ver: { color: C.textMuted, fontSize: 12, textAlign: 'center', marginTop: 48 },
});
